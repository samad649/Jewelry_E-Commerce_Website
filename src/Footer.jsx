import {
  ...
  export default function Footer() {
    ...
    useEffect(() => {
      const handleScroll = () => {
        const scrollPosition = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollBottom;
        ...
        setIsFixed(scrollPosition + window.innerHeight >= documentHeight);
      };
    ...
    return (
      <Box
      className={`footer ${isFixed ? 'fixed' : ''}`}
      zIndex={3}
      width={'100vw'}
      borderTop={'4px solid #E9D5CA'}
        bg={'#363062'}
        color={useColorModeValue('#E9D5CA', 'gray.200')}>
        <Container as={Stack} maxW={'6xl'} pt={4} pb={4}>
          <SimpleGrid 
          zIndex={3.5}
